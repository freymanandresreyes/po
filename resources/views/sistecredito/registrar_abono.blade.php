...
<div id="appVue">
    ...
    <div class="col-lg-12">
      <div class="card ">
        <div class="card-header bg-info">
          <h4 class="m-b-0 text-white">CONSULTAR FACTURAS SISTECREDITO POR CLIENTE</h4>
        </div>
        <div class="card-body">
                ...
                <div class="form-body">
                  ...
                  <div class="text-right">
                      <button type="button" class="btn btn-success" v-on:click="buscaFacturasCliente">Buscar facturas</button>
                    </div>
                </div>
              </form>
        </div>
  ...
  <div v-if="loaderVue" class="text-center">
    <h2><i class="fa fa-refresh fa-spin"></i> Consultando facturas de este cliente</h2>
  </div>
                                ...
                                <tr v-for="(factura, index) in facturasCliente.facturas_cliente">
                                    ...
                                    <div class="modal-dialog" role="document">
                                      <div class="modal-content" id="factura_compra">
                                          ...
                                          <div v-if="abonosFactura.abonosFactura.length <= 0">
                                           <p><em></em></p>
                                            ...
                                            <div class="text-right" style="padding-right: 10px;">
                                              <h4><b>Total abonos: $ @{{ formatNumber(abonosFactura.total_abonos) }}</b></h4>
                                            </div>
                                          </div>
                                         <div v-if="parseInt(abonosFactura.total_abonos) < parseInt(factura.saldo_sistecredito)">
                                              <h4><i class="fa fa-money"></i> Realizar un abono</h4>
                                              <h5>* Total saldo pendiente: <b>$ @{{ formatNumber(facturasCliente.facturas_cliente[index].saldo_sistecredito - abonosFactura.total_abonos ) }}</b></h5>
                                             <div class="form-group row">
                                            <label class="control-label text-right col-md-3"><i class="fa fa-dollar"></i> Valor a abonar:</label>
                                            <div class="col-md-9">
                                              <input type="number" class="form-control custom-select" v-model="valorAbonoFacturaSistecredito">
                                            </div>
                                          </div>
                                            <div class="form-group row">
                                            <label class="control-label text-right col-md-3"><i class="fa fa-cc"></i> Forma de pago:</label>
                                            <div class="col-md-9">
                                              <select class="form-control" id="forma_pago_sistecredito" v-model="formaPagoAbonoFacturaSistecredito">
                                          ...
                                          <div class="text-right">
                                            <button v-if="(valorAbonoFacturaSistecredito > 0 && (facturasCliente.facturas_cliente[index].saldo_sistecredito - abonosFactura.total_abonos ) >= valorAbonoFacturaSistecredito)" class="btn-success btn" type="button" title="Abonar a la factura" v-on:click="AbonaFacturaSistecredito(facturasCliente.cliente.id,factura.n_factura,index)">Abonar a la factura</button>
                                            <div v-else>
                                              <div class="alert alert-danger">
                                              <strong><i class="fa fa-times"></i> El valor del abono debe ser mayor que cero y no puede superar el saldo total pendiente</strong>
                                            </div>
                                            </div>
                                          </div>
                                         </div>
                                        ...
                                        <div v-if="errors != ''">
                                          <h5><b><i class="fa fa-times"></i> Hay algunos errores: </h5>
                                        <ul>
