                  ...
                  <!--/row-->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="text-right">
                          <button type="button" class="btn btn-success" id="guardar_devolucion">Registrar devolución</button>
                        </div>
                      </div>
                  </div>
                </div>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger waves-effect waves-light" id="registrar_devolucion">Registrar</button>
                  </div>
                </div>
              </div>
            </div>
